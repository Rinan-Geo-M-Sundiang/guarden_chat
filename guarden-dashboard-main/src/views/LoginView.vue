  ...
  <div class="min-h-screen bg-garden-void flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="relative w-full max-w-sm">
      ...
      <div class="text-center mb-8 animate-fade-in">
        ...
        <h1 class="font-display font-semibold text-4xl text-garden-text tracking-tight cursor-pointer" @click="router.push('/dashboard')">
          Guarden
        </h1>
      ...
      <div class="bg-garden-surface border border-garden-border rounded-2xl shadow-card
        ...
        <div v-if="showForgot" class="p-8 space-y-5">
          <button
            class="text-xs font-mono text-garden-dim flex items-center gap-1
        ...
        <div v-else class="p-8 space-y-5">
            ...
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  placeholder="••••••••"
                  class="w-full px-4 py-3 rounded-xl border border-garden-border bg-garden-card
                         font-mono text-sm text-garden-text placeholder-garden-muted pr-14
                         focus:outline-none focus:border-garden-live focus:ring-1
                         focus:ring-garden-live/30 transition-all"
                  @keydown.enter="handleEmail"
                />
          ...
          <!-- Error -->
          <p v-if="errorMsg" class="text-garden-danger text-xs font-mono">
            {{ errorMsg }}
          </p>
          ...
          <div class="flex items-center justify-between">
            ...
            <router-link
              to="/register"
              class="font-mono text-[11px] text-garden-live hover:underline
