  ...
  <nav class="sticky top-0 z-50 w-full border-b border-garden-border bg-garden-void/80 backdrop-blur-md">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-3">
        ...
        <!-- Dashboard link (shown on admin page) -->
        <router-link
        ...
        <div class="relative" ref="menuRef">
          <button
            class="flex items-center gap-2 px-2.5 py-1.5 rounded-xl border border-garden-border
                   bg-garden-card hover:bg-garden-base transition-colors group"
          ...
          >
            ...
            <svg class="w-3 h-3 text-garden-muted transition-transform"
          ...
          <div
            v-if="menuOpen"
            class="absolute right-0 top-full mt-2 w-52 bg-garden-surface border border-garden-border
                   rounded-xl shadow-card overflow-hidden z-50 animate-fade-in"
          >
            <!-- User info -->
            <div class="px-4 py-3 border-b border-garden-border">
              ...
              <div class="mt-1">
                <span class="font-mono text-[9px] uppercase tracking-wider px-1.5 py-0.5 rounded"
                      :class="isAdmin
